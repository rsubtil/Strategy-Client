...
public final class Methods {
     ...
     *
     * @deprecated Use Material property "MagNearest" on .j3m files instead.
     */
    @Deprecated
    ...
    // TODO: The method only accepts Lists of Grass, should be changed to Squares if needed
    ...
    public static FilterPostProcessor getFpp(ViewPort viewPort, AssetManager assetManager) {
        // Finds a FilterPostProcessor in case there is one
        ...
        // If there's no FilterPostProcessor, create new one
